                                        ...
                                        <div className="cart__item">
                                            <div className="cart__book">
                                                ...
                                                <div className="cart__book--info">
                                                    ...
                                                    <buttton className="cart__book--remove" onClick={() => removeItem(book)}>Remove</buttton>
                                                </div>
                                            </div>
                                            <div className="cart__quantity">
                                                <input type="number" min={0} max={99} className="cart__input" value={book.quantity} onChange={
                                                    (event) => changeQuantity(book, event.target.value)
                                                }/>
                                            </div>
